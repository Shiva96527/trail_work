    ...
    <div id="after-login-header">
      <Navbar className="login-header-color" expand="lg">
        ...
        <UncontrolledCollapse toggler="#toggler" navbar className="left-menu">
          <Nav className="ml-auto" navbar>
            ...
            <NavItem>
              <NavLink
                ...
                onClick={() =>
                  handleNavClick("/neptune/srf/mygroup", "My Group")
                }
              >
                My Group
              </NavLink>
            ...
            <NavItem>
              <NavLink
                ...
                onClick={() =>
                  handleNavClick("/neptune/srf/srfoutbox", "Outbox")
                }
              >
                Outbox
              </NavLink>
            ...
            {isAdminVisible && (
              ...
              >
                ...
                <DropdownMenu>
                  ...
                  <DropdownItem
                    onClick={() => navigate("/admin/dropdownconfig")}
                  >
                  ...
                  <DropdownItem
                    onClick={() => navigate("/admin/buildingdetails")}
                  >
                    Building Details
                  </DropdownItem>
                  ...
                  <DropdownItem
                    onClick={() => navigate("/admin/vascostconfig")}
                  >
                    VAS Cost Catalogue
                  </DropdownItem>
                </DropdownMenu>
            ...
            {isreportMenusVisible && (
              ...
              >
                ...
                <DropdownMenu>
                  <DropdownItem
                    onClick={() => navigate("/neptune/reports/srfreport")}
                  >
                    SRF Report
                  </DropdownItem>
                </DropdownMenu>
            ...
            {isEdQuotationVisible && (
              ...
              >
                ...
                <DropdownMenu>
                  <DropdownItem
                    onClick={() => navigate("/neptune/edquotation/inbox")}
                  >
                    My Inbox
                  </DropdownItem>
                  <DropdownItem
                    onClick={() => navigate("/neptune/edquotation/mygroup")}
                  >
                    My Group
                  </DropdownItem>
                  <DropdownItem
                    onClick={() => navigate("/neptune/vendor/management")}
                  >
                    Vendor Management
                  </DropdownItem>
                </DropdownMenu>
          ...
          >
            <p style={letterStyle} title={displayName}>
